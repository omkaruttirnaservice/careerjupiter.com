    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-center bg-cover bg-center relative p-6 rounded-lg"
      ...
      <div className="z-10 text-center text-white max-w-2xl ">
        <h1 className="text-2xl md:text-4xl font-bold flex items-center gap-3">
          <FaCrown className="text-yellow-400 animate-pulse text-4xl md:text-4xl" /> SEARCH BEST UNIVERSITY
        </h1>
        ...
        <button
          ...
          className="w-full border-2 flex items-center justify-center gap-3 bg-blue-500 text-white px-6 py-3 rounded-full font-bold text-lg shadow-lg hover:bg-blue-600 transition-transform duration-300 hover:scale-105"
        >
