...
// //   return (
// //     <div className="flex flex-col items-center w-full   sm:h-[70vh] md:h-[70vh]  ">
// //       <div className="relative w-[99%] h-auto overflow-hidden rounded-2xl shadow-lg">
// //         <div
...
// //         <h1 className="text-xl sm:text-5xl md:text-5xl font-bold flex flex-wrap justify-center items-center gap-2">
// //           FIND YOUR
// //           <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 animate-gradient">
// //             <TypewriterComponent
// //               options={{ loop: true }}
// //               onInit={(typewriter) => {
// //                 typewriter
...
// //         <p className="mt-3 max-w-md mx-auto text-base font-bold text-blue-200 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
