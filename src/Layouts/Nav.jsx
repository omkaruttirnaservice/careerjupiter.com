...
const Nav = () => {
  ...
  const profilePic = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsEJHmI0MlIGvH9CYkbsLEWQ5_ee8Qtl5V-Q&s';
                  ...
                  <Menu as="div" className="relative">
                    ...
                    >
                      <Menu.Items className="absolute right-0 mt-2 w-48 bg-white border rounded-md shadow-lg">
                        <Menu.Item>
                          {({ active }) => (
                            <NavLink to="/profile/personal-details" className={`block px-4 py-2 ${active ? 'bg-gray-100' : ''}`}>
                              Profile
                            </NavLink>
                          )}
                        </Menu.Item>
                        <Menu.Item>
                          {({ active }) => (
                            <button onClick={handleSignOut} className={`block w-full text-left px-4 py-2 text-red-600 ${active ? 'bg-gray-100' : ''}`}>
                              Sign Out
                            </button>
                          )}
                        </Menu.Item>
