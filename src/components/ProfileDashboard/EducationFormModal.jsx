...
export default function EducationFormModal({ isOpen, setIsOpen }) {

      const mutation = useMutation({
        mutationFn: setEducation,
        onSuccess: (data) => {
          console.log(data, "Add Eduction data");
          toast.success("Add Eduction successful!");
        },
  ...
  const validationSchema = Yup.object().shape({
    ...
    endYear: Yup.string().when("isPursuing", {
      is: false,
  ...
  return (
    <Dialog
      ...
      className="fixed z-50 inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center"
    >
