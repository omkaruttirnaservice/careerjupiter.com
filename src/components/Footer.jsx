...
const Footer = () => {
  return (
    <div className="mt-auto bg-gray-100 text-blcyan">
      <footer className="footer p-10">
        <nav className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <a className="link link-hover hover:text-cyan-400 transition-colors">Aboutus  </a>
      ...
      <footer className="footer px-10 py-4 border-t bg-gray-100 border-cyan-700">
        <aside className="items-center grid-flow-col">
          <p className="text-sm text-black font-bold ">
            Copyright © {new Date().getFullYear()} - All rights reserved by UTTIRNA SERVICES LLP
          </p>
        </aside>
