    ...
    <>
      ...
      <div className="mt-10 min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-6 sm:p-10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <h1 className="text-2xl md:text-5xl bg font-bold text-center mb-12 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
          ...
          <center>
            <div className="flex justify-center">
              {services.map((service, index) => (
                <div
                  key={index}
                  className="max-w-md w-full group relative bg-white rounded-2xl p-6 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl border-2 border-purple-50 hover:border-purple-100"
                >
                  {/* New Floating Ribbon */}
