...
//               onClick={() => navigate(`/college/${college._id}`, { state: { status: false, searchData: selectedData } })}
...
//               // onClick={() => navigate(`/college/${college._id}/status=true`)}
//               onClick={() =>
//                 navigate(`/college/${college._id}`, {
//                   state: { status: false, searchData: selectedData },
//                 })
//               }
//               target="_blank"
