...
function TestCard() {
	...
	const currentEducation = useSelector((state) => state.education.currentEducation);
	...
	return (
		<div className="p-4">
			...
			<div className="mb-6">
				<label htmlFor="educationType" className="block text-lg font-medium text-gray-700 mb-2">
