...
//   // Regular category tests mutation
//   const {
//     data: test_List,
//     mutate: fetchTestList,
//     isPending,
...
//   // Fetch regular tests only when no roadmap ID
//   useEffect(() => {
//     if (categoryId && sub_Category && sub_sub_Category && !roadmapId) {
//       fetchTestList();
//     }
//   }, [categoryId, sub_Category, sub_sub_Category, roadmapId]);

//   // Determine which tests to show
//   const iqtests = roadmapId
//     ? roadmapTestsData?.data?.results || []
//     : externalTestList && externalTestList.length > 0
//     ? externalTestList
//     : externalCompetedTestList && externalCompetedTestList.length > 0
//     ? externalCompetedTestList
...
//   // Loading state
//   const isLoading = roadmapId ? isRoadmapLoading : isPending;
...
//     // Ignore clicks that come from buttons
...
//     } else if (test?.attempted === 1) {
//       // Already completed test - do nothing on card click
//       return;
//     }
//   };
...
//   return (
//     <div className="p-4">
//       {/* Show roadmap heading when roadmap ID exists */}
//       {roadmapId && (
//         <div className="mb-6">
//           <h1 className="text-2xl font-bold text-gray-800">
//             🎯 IQ Tests for Roadmap
//           </h1>
...
//       {/* Show breadcrumb only for regular tests */}
//       {!roadmapId && (
//         <Breadcrumb
//           mainCategoryName={mainCategoryName}
//           subCategoryName={subCategoryName}
...
//           {roadmapId ? "No tests available for this roadmap." : "No tests available."}
//         </div>
//       ) : (
//         <div className="grid grid-cols-1 mt-5 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//           {iqtests?.map((test) => {
...
//                     className="absolute bottom-2 right-2 bg-yellow-600 text-white text-xs font-bold px-2 py-1 rounded-md shadow"
//                   >
//                     In-Progress
//                   </button>
//                 )}
