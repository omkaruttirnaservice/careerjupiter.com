...
import { IoArrowForwardOutline, IoSearchOutline, IoTimeOutline } from 'react-icons/io5';
...
const SearchComponent = () => {
	...
	return (
		<div className="w-full flex items-center justify-between mt-16 bg-green-200 p-4">
  {/* Search Bar */}
  <div className="w-full max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl">
    <div className="flex border-2  border-gray-400 rounded-full overflow-hidden w-full ml-8">
      <input
        type="text"
  ...
  {/* Card */}
  <div className="bg-green-500 p-2 rounded-xl mr-17 w-96">
    {/* Header */}
    ...
    <p className="text-gray-100 font-bold mb-6 leading-relaxed">
      Test your intelligence and problem-solving skills with this quick IQ test.
    </p>
    ...
    <div className="flex items-center justify-between">
	  ...
	  <NavLink
        ...
        >
      <button className="bg-blue-500 cursor-pointer ml-30 text-white px-6 py-3 rounded-md text-md font-medium flex items-center space-x-2  transition-all duration-300 ease-in-out group">
