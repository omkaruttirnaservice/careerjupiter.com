...
const SearchComponent = () => {
  const { tagName, query, setQuery, setCollegesData, setIsLoading, setUniversityData, setInstitutesData, setErrorMsg } =
    useSearchContext()
          ...
          <main className="mx-auto max-w-7xl px-4">
            <div className="text-center">
              <div className="flex flex-row justify-center gap-2 sm:gap-4 md:gap-5 text-lg sm:text-3xl md:text-4xl font-bold">
                <h1 className="text-gray-900 font-extrabold text-base sm:text-xl md:text-3xl">FIND YOUR</h1>
      ...
      <div className="flex items-center justify-center p-4 mt-4 md:mt-0">
        ...
        <div className="bg-green-500 p-2 rounded-xl w-full md:w-96 max-w-sm">
          ...
          <div className="flex items-center justify-between">
            {/* Animated Button */}
            <NavLink to="profile/test" className="text-white hover:text-green-800 flex flex-row gap-2 ml-auto">
