...
const SignupPopup = () => {
  ...
  useEffect(() => {
    const handleAuthState = () => setIsOpen(!authState.isLoggedIn);
    window.addEventListener("scroll", handleAuthState);
    return () => window.removeEventListener("scroll", handleAuthState);
